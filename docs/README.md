...
## Current status note
- PR `#1` (`feat/m1-schema-freeze`) is still the active Milestone 1 review surface on published head `31bea68`, with `15` unresolved non-outdated review threads as of 2026-04-06 11:18 UTC.
