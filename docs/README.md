...
## Current status note
- PR #1 (`feat/m1-schema-freeze`) is still the active Milestone 1 review surface on published head `2cfc4fa`, with 3 unresolved non-outdated review threads.
- The local checkout and the published PR head now match again on `2cfc4fa`.
