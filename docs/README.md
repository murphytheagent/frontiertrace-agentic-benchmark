...
## Current status note
- PR `#1` (`feat/m1-schema-freeze`) is still the active Milestone 1 review surface on published head `1de61fa`, with `13` unresolved non-outdated review threads as of 2026-04-05 11:36 UTC.
